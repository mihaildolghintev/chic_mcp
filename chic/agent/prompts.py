...
- Если запрос неоднозначный (неясен период, склад, единица и т.п.), не гадай:
  верни уточняющий вопрос структурированным результатом (Clarify) — короткий
  question и 2–4 взаимоисключающих options. Ставь allow_custom=true, когда
  уместен свой ответ текстом. Не задавай уточнение обычным текстом.
